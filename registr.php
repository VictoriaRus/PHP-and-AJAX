  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-sm-6">
        ...
        <br>
        <form action="">
          Логин<input type="text" name="login" placeholder="Введите логин" class="form-control" /><br>
          Пароль<input type="password" id="txtNewPassword" name="password" placeholder="Введите пароль" class="form-control" /><br>
          ...
          Имя<input type="text" name="name" placeholder="Введите имя" class="form-control" /><br>
